...
class Schedule_set extends CI_Controller {
  ...
  public function __construct()
  {
    ...
    $this->load->model(array('bulan/Bulan_model', 'schedule/Schedule_model', 'student/Student_model', 'lesson/Lesson_model', 'period/Period_model', 'setting/Setting_model'));
...
// Get $_GET variable
  ...
  public function cetak($offset = NULL) {
    ...
    $data = pdf_create($html, 'Jadwal_Pelajaran_' . $data['majors']['majors_short_name'] . '_' . $data['class']['class_name'] . '_' . $data['period']['period_start'] . '/' . $data['period']['period_end'], TRUE, 'A4', TRUE);
  }
