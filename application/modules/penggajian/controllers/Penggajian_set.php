...
class Penggajian_set extends CI_Controller {
  ...
  public function set($id = NULL) {
    ...
    if ($_POST) {
      ...
      $params['premier_fungsional']  = $this->input->post('premier_fungsional');
      $params['premier_tambahan']    = $this->input->post('premier_tambahan');
      
      $params['sekunder_transport']  = $this->input->post('sekunder_transport');
      $params['sekunder_hr']         = $this->input->post('sekunder_hr');
      $params['sekunder_penyesuaian']= $this->input->post('sekunder_penyesuaian');
      $params['sekunder_kepala_keluarga']= $this->input->post('sekunder_kepala_keluarga');
      $params['sekunder_piket']      = $this->input->post('sekunder_piket');
      $params['sekunder_kurleb']     = $this->input->post('sekunder_kurleb');
      $params['sekunder_koreksi']    = $this->input->post('sekunder_koreksi');
      $params['sekunder_lain']       = $this->input->post('sekunder_lain');
      
      $params['potongan_absen']      = $this->input->post('potongan_absen');
      $params['potongan_infak']      = $this->input->post('potongan_infak');
      $params['potongan_bmt']        = $this->input->post('potongan_bmt');
      $params['potongan_koperasi']   = $this->input->post('potongan_koperasi');
      $params['potongan_qurban']     = $this->input->post('potongan_qurban');
      $params['potongan_lain']       = $this->input->post('potongan_lain');
      $params['potongan_spp_anak']   = $this->input->post('potongan_spp_anak');
      
      $status_akun      = $this->Penggajian_model->set_akun($params);
      $status_premier   = $this->Penggajian_model->set_premier($params);
      $status_sekunder  = $this->Penggajian_model->set_sekunder($params);
      ...
      $paramsupdatesekunder['employee_id']  = $status_sekunder;
      ...
      $this->Penggajian_model->set_sekunder($paramsupdatesekunder);
