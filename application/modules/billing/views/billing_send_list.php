				...
				<div class="box box-success">
					<div class="box-header">
						...
						<div class="row">
					        ...
					        <!--<a data-toggle="modal" class="btn btn-success" title="Pastikan Sudah Ada Santri yang Dicentang" href="#kirimPemberitahuan" onclick="get_form_blast()"><span class="fa fa-whatsapp"></span> Kirim Pemberitahuan</a>-->
							<?php } ?>
						    </div>
					        </div>
					</div>
	                ...
	                <div class="modal fade" id="kirimPemberitahuan" role="dialog">
            			<div class="modal-dialog modal-md">
            				<div class="modal-content">
            					...
            					<div class="modal-body">
            		            <?php //echo form_open('manage/billing/blast/', array('method'=>'post')); ?>
            		                <p>Anda Yakin Mau Mengirim Tagihan ke Orang Tua Santri Tersebut?</p>
            		                <input type="hidden" class="form-group" name="period_id" value="<?php echo $q['p'] ?>">
            		                <input type="hidden" class="form-group" name="majors_id" value="<?php echo $q['k'] ?>">
            		                <input type="hidden" class="form-group" name="class_id" value="<?php echo $q['c'] ?>">
