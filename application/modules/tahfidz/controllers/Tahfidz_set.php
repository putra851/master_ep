...
// Santri
    ...
    //$data['tahfidz']      = $this->Tahfidz_model->get((isset($periodID['period_id']) ? $periodID['period_id'] : '')&& (isset($siswa['student_id']) ? $siswa['student_id'] : ''));
    $data['tahfidzSum'] = $this->Tahfidz_model->get_sum(array('period_id'=>$periodID, 'student_id'=>$siswa['student_id']));
    //$data['tahfidzSum']   = $this->Tahfidz_model->get_sum((isset($periodID['period_id']) ? $periodID['period_id'] : '')&& (isset($siswa['student_id']) ? $siswa['student_id'] : ''));
