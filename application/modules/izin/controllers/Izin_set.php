...
// Santri
    ...
    public function add(){
		if ($_POST == TRUE) {
			...
			$params['izin_note']       = $this->input->post('izin_note');
...
// Santri
  ...
  public function izin_excel() {
    ...
    $data['izin']   = $this->db->query("SELECT student_nis, student_full_name, class_name, majors_short_name, madin_name, izin_id, izin_date, izin_time, izin_note FROM izin JOIN student ON student.student_id = izin.izin_student_id JOIN class ON class.class_id = student.class_class_id JOIN majors ON majors.majors_id = student.majors_majors_id LEFT JOIN madin ON madin.madin_id = student.student_madin WHERE izin_id = '$id'")->row_array();
