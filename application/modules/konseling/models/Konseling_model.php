...
class Konseling_model extends CI_Model {
	...
	function get($params = array())
	{
		...
		if (isset($params['code'])) {
			$this->db->where('konseling_code', $params['code']);
		}
		...
		$this->db->select('konseling_id, konseling_period_id, konseling_date, konseling_true, konseling_foul, konseling_action, konseling_code, konseling_poin, konseling_note');
	...
	function add($data = array()) {
		...
		if(isset($data['konseling_true'])) {
			$this->db->set('konseling_true', $data['konseling_true']);
		}
		...
		if(isset($data['konseling_code'])) {
			$this->db->set('konseling_code', $data['konseling_code']);
		}
