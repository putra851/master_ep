	...
	<table>
		...
		<table style="border-style: solid;">
			<tr>
				...
				<th style="border-top: 1px solid; border-bottom: 1px solid;">Kebaikan</th>
				<th style="border-top: 1px solid; border-bottom: 1px solid;">Apresiasi</th>
			...
			<tr>
				...
				<td style="border-bottom: 1px solid;"><?php echo $row['konseling_true'] ?></td>
