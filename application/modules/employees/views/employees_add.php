				...
				<div class="box box-primary">
					...
					<div class="box-body">
    						...
    						<div class="form-group">
    							<label>NIY <small data-toggle="tooltip" title="Wajib diisi">*</small></label>
    							<input name="employee_nip" type="text" class="form-control" value="<?php echo $inputNipValue ?>" placeholder="NIY Pegawai">
    						</div> 
    						<div class="form-group">
    						...
    						<div id="div_position">
    						    ...
    						    <div class="form-group">
    								...
    								<select name="employee_category" id="employee_category" class="form-control">
    									...
    									<option value="1" <?php echo ($inputCategoryValue == 1) ? 'selected' : ''; ?>>  Magang </option>
    									<option value="2" <?php echo ($inputCategoryValue == 2) ? 'selected' : ''; ?>>  Kontrak </option>
    									<option value="3" <?php echo ($inputCategoryValue == 1) ? 'selected' : ''; ?>>  GTT / PTT </option>
    									<option value="4" <?php echo ($inputCategoryValue == 2) ? 'selected' : ''; ?>>  GTY / PTY </option>
    									<option value="5" <?php echo ($inputCategoryValue == 2) ? 'selected' : ''; ?>>  GTYP / PTYP </option>
    								</select>
    							</div>
    						<div class="form-group">
    							<label>Alamat</label>
