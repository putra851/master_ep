...
// Santri
  ...
  public function pulang_excel() {
    ...
    $data['pulang']   = $this->db->query("SELECT student_nis, student_full_name, class_name, majors_short_name, madin_name, pulang_id, pulang_date, pulang_days, pulang_note FROM pulang JOIN student ON student.student_id = pulang.pulang_student_id JOIN class ON class.class_id = student.class_class_id JOIN majors ON majors.majors_id = student.majors_majors_id LEFT JOIN madin ON madin.madin_id = student.student_madin WHERE pulang_id = '$id'")->row_array();
